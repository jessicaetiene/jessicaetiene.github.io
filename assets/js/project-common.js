  ...
  const render = async (lang) => {
    ...
    root.innerHTML = `
      <aside class="project-sidebar">
        <a class="project-nav-item active" href="#">${name}</a>
      ...
      <section class="project-content">
        <header class="content-header project-content-header">
          <h1>${name}</h1>
          ...
          <button id="themeToggle" class="theme-toggle">${document.body.classList.contains('dark') ? t.themeLight : t.themeDark}</button>
        </header>
